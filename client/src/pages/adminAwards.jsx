...
const adminAwards = () => {
  ...
  return (
    <>
        ...
        <FormModalWrapper id='create_modal' title='Create Project' modalVar={createModalOn} closeModal={() => {setCreateModalOn(false)}}>
            <form action="">
                <div className="input_holder">
                    <input type="text" name="" id="" placeholder='Award title' required />
                    <input type="date" name="" id="" placeholder='Date' required />
                </div>
        ...
        {/*delete modal*/} 
        <ConfirmModalWrapper title='Delete All?' closeModal={() => {setDelAllModalOn(false)}} modalOn={delAllModalOn} message='Are you sure you want to delete all the awards? They cannot be recovered!' />
